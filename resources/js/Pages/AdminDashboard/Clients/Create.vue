...
/>
                ...
                <div>
                    ...
                    <input
                        ...
                        type="text"
                        placeholder="e.g. 29001010001"
                        :class="['w-full px-4 py-2.5 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400 bg-white',
                            form.errors.national_id ? 'border-red-400' : 'border-gray-200']"
                    />
                    <p v-if="form.errors.national_id" class="text-xs text-red-500 mt-1">{{ form.errors.national_id }}</p>
                </div>
