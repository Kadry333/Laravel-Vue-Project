...
const submit = () => {
    form.transform((data) => ({
        ...data,
        _method: "patch",
    })).post(route("admins.profile.update"), {
        forceFormData: true,
        preserveScroll: true,
    });
};
...
<template>
    ...
    <div class="min-h-screen bg-[#f4f7fb] px-4 py-8 sm:px-6 lg:px-8">
        <div class="mx-auto w-full max-w-5xl space-y-6">
            <div
                class="rounded-3xl border border-[#d9e2ec] bg-white p-6 shadow-sm sm:p-8"
            >
                <div class="space-y-2">
                    <p
                        class="text-xs font-semibold uppercase tracking-[0.22em] text-[#5b708b]"
                    >
                        Staff Profile
                    </p>
                    <h1
                        class="text-3xl font-semibold tracking-tight text-[#0c1a2e] sm:text-4xl"
                    >
                        Admin Profile
                    </h1>
                    <p class="max-w-2xl text-sm leading-6 text-[#5b708b]">
                        Keep your profile details up to date while staying
                        consistent with the shared dashboard design system.
                    </p>
                </div>
            </div>
            ...
            >
                <section
                    class="rounded-3xl border border-[#d9e2ec] bg-white p-6 shadow-sm sm:p-7"
                >
                    <div class="flex flex-col items-center text-center">
                        <div class="relative">
                            <div
                                class="h-32 w-32 overflow-hidden rounded-full border-4 border-[#edf2f7] bg-[#edf2f7] shadow-sm sm:h-36 sm:w-36"
                            >
                                <img
                                    :src="previewImage"
                                    alt="Profile Image"
                            ...
                            <div
                                class="absolute bottom-1 right-1 rounded-full border border-white bg-[#0c1a2e] p-2 text-white shadow"
                            >
                    ...
                    <div class="mt-6 space-y-2">
                        ...
                        />
                        <div
                            class="flex items-center gap-3 rounded-xl border border-[#d9e2ec] bg-white p-2"
                        >
                            <Button
                                type="button"
                                variant="outline"
                            ...
                            <span
                                class="min-w-0 flex-1 truncate text-sm text-[#0c1a2e]"
                            >
                                {{ selectedAvatarName }}
                            </span>
                        </div>
                ...
                >
                    <div
                        class="flex flex-col gap-2 border-b border-[#e7edf5] pb-5"
                    >
                        <h2 class="text-xl font-semibold text-[#0c1a2e]">
                            Personal Information
                        </h2>
                        <p class="text-sm leading-6 text-[#5b708b]">
                            Review and update the details associated with your
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div class="space-y-2 md:col-span-2">
                            <Label for="name" class="text-[#0c1a2e]"
                                >Name</Label
                            >
                            <div class="relative">
                                <UserRound
                        ...
                        <div class="space-y-2 md:col-span-2">
                            <Label for="email" class="text-[#0c1a2e]"
                                >Email</Label
                            >
                            <div class="relative">
                                <Mail
                        ...
                        <div class="space-y-2 md:col-span-2">
                            <Label for="national_id" class="text-[#0c1a2e]"
                                >National ID</Label
                            >
                            <div class="relative">
                                <IdCard
                    ...
                    <div
                        class="mt-8 flex flex-col gap-3 border-t border-[#e7edf5] pt-6 sm:flex-row sm:items-center sm:justify-between"
                    >
            ...
            <form v-else @submit.prevent="submit" class="space-y-6">
                <Card class="rounded-3xl border-[#d9e2ec] shadow-sm">
                    <CardContent class="p-6 sm:p-7">
                        <div
                            class="flex items-start gap-4 border-b border-[#e7edf5] pb-5"
                        >
                            <div
                                class="rounded-2xl bg-slate-100 p-3 text-[#0c1a2e]"
                            >
                                <ShieldCheck class="h-5 w-5" />
                            </div>
                            <div class="space-y-1">
                                <h2
                                    class="text-xl font-semibold text-[#0c1a2e]"
                                >
                                    Personal Information
                                </h2>
                                <p class="text-sm leading-6 text-[#5b708b]">
                                    Review and update the details associated
                                    with your
                                    {{ roleLabel.toLowerCase() }} account.
                                </p>
                            </div>
                        ...
                        <div class="mt-6 grid grid-cols-1 gap-6">
                            <div class="space-y-2">
                                <Label for="admin-name" class="text-[#0c1a2e]"
                                    >Name</Label
                                >
                                <div class="relative">
                                    <UserRound
                            ...
                            <div class="space-y-2">
                                <Label for="admin-email" class="text-[#0c1a2e]"
                                    >Email</Label
                                >
                                <div class="relative">
                                    <Mail
