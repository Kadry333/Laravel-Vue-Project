...
const selectedCountryName = computed(() => {
    ...
    return (
        ...
        props.user?.country?.official_name ??
        "Select country"
    );
});
            ...
            >
                <div class="space-y-2">
                    ...
                    <p class="max-w-2xl text-sm leading-6 text-[#5b708b]">
                        Keep your personal details up to date and choose the
                        profile image that appears across your client account.
                    </p>
                </div>
            </div>
            ...
            >
                ...
                >
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            <Label for="country" class="text-[#0c1a2e]"
                                >Country</Label
                            >
                            ...
                            <Popover v-model:open="countryOpen">
                                <PopoverTrigger as-child>
                                    ...
                                    >
                                        ...
                                        >
                                            <MapPin
                                                class="h-4 w-4 shrink-0 text-[#5b708b]"
                                            />
                                            <span class="truncate">
                                                {{ selectedCountryName }}
                                            </span>
                                        ...
                                        <ChevronsUpDown
                                            class="ml-2 h-4 w-4 shrink-0 text-[#5b708b]"
                                        />
                                    </Button>
                                </PopoverTrigger>
                                ...
                                >
                                    <Command class="bg-white text-[#0c1a2e]">
                                        ...
                                        />
                                        <CommandEmpty
                                            class="py-6 text-center text-sm text-[#5b708b]"
                                        >
                                            No country found.
                                        </CommandEmpty>
                        ...
                        <div class="space-y-2">
                            <Label for="gender" class="text-[#0c1a2e]"
                                >Gender</Label
                            >
                            <Select v-model="form.gender">
                                ...
                                <SelectContent
                                    class="border border-[#d9e2ec] bg-white text-[#0c1a2e] shadow-xl"
                                >
                                    <SelectItem
                                        value="male"
