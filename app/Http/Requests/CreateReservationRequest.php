        ...
        return [
            ...
            'room_id' => [
                ...
                function ($attribute, $value, $fail) {
                    $approved = \App\Models\Reservation::where('room_id', $value)
                    ...
                    if ($pending) {
                        $fail('This room is currently being booked by someone else, please try again in 30 minutes.');
                    }
                },
            ],
        ];
